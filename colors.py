...
#for transaction in daily_transactions_split:
 # for day in transaction:
  #  transactions_clean.append(day.strip())
...
for i in range(len(colors)):
    counts = color_count(colors[i])
    message = "Thread Shed sold {N} threads of {TC} thread today."
    message.format(N = counts,TC = colors[i])
    print(message)